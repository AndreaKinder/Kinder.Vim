...
-- Mapea Ctrl+b en modo inserción para borrar hasta el final de la palabra sin salir del modo inserción
vim.keymap.set("i", "<C-b>", "<C-o>de")

-- Mapea Ctrl+c para escapar de otros modos
vim.keymap.set({ "i", "n", "v" }, "<C-c>", [[<C-\><C-n>]])

----- Navegación Tmux ------
local nvim_tmux_nav = require("nvim-tmux-navigation")

vim.keymap.set("n", "<C-h>", nvim_tmux_nav.NvimTmuxNavigateLeft) -- Navegar al panel izquierdo
vim.keymap.set("n", "<C-j>", nvim_tmux_nav.NvimTmuxNavigateDown) -- :require:1Navegar al panel inferior
vim.keymap.set("n", "<C-k>", nvim_tmux_nav.NvimTmuxNavigateUp) -- Navegar al panel superior
vim.keymap.set("n", "<C-l>", nvim_tmux_nav.NvimTmuxNavigateRight) -- Navegar al panel derecho
vim.keymap.set("n", "<C-\\>", nvim_tmux_nav.NvimTmuxNavigateLastActive) -- Navegar al último panel activo
vim.keymap.set("n", "<C-Space>", nvim_tmux_nav.NvimTmuxNavigateNext) -- Navegar al siguiente panel
